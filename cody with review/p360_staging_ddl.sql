-- =============================================================================
-- P360 STAGING — DDL
-- Daily snapshot of all current source data (mirrors output of
-- p360_final_view_claude.sql). Truncated and reloaded each day by
-- p360_staging_refresh.sql.
...
SORTKEY (code_number, city_id, vertical, cycle_type, recognised_date);  -- aligns with batch_runner FULL OUTER JOIN key
